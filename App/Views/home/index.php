...
if ($idPermissao != 4) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title" style="font-size:15px">
                                    Ativos <?php echo $produtosCadastrados->ativos; ?>
                                <p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            <div class="numbers">
                                ...
                                <p class="card-title" style="font-size:15px">
                                    Ativos <?php echo $clientesCadastrados->ativos; ?>
                                <p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a href="<?php echo BASEURL; ?>/pdvDiferencial" class="btn btn-primary">PDV Diferencial</a>
                <a href="<?php echo BASEURL; ?>/pdvPadrao" class="btn btn-primary">PDV Padrão - Completo</a>
                <a href="<?php echo BASEURL; ?>/produto" class="btn btn-primary">Consulta de Produtos</a>
            </div>
    ...
    <?php } else { ?>
        <div class="card text-center">
            ...
            <div class="card-body">
                <h5 class="card-title">Acesso Rápido</h5>
                <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                <a href="<?php echo BASEURL; ?>/pdvDiferencial" class="btn btn-primary">Vendas</a>
                <a href="<?php echo BASEURL; ?>/produto" class="btn btn-primary">Consulta de Produtos</a>
            </div>
            <div class="card-footer text-muted">
                DanielTECH Sistemas
